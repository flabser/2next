...
Ember.TEMPLATES["accounts"] = Ember.HTMLBars.template((function() {
  ...
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var morph2 = dom.createMorphAt(dom.childAt(element9, [3]),1,1);
      var morph3 = dom.createMorphAt(dom.childAt(element9, [5]),1,1);
      var morph4 = dom.createMorphAt(dom.childAt(element9, [7]),1,1);
...
Ember.TEMPLATES["transaction"] = Ember.HTMLBars.template((function() {
  return {
    ...
    build: function build(dom) {
      ...
      dom.setAttribute(el6,"name","name");
      dom.setAttribute(el6,"class","span7");
