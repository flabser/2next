...
Ember.TEMPLATES["account"] = Ember.HTMLBars.template((function() {
  return {
    ...
    build: function build(dom) {
      ...
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","control-label");
      var el6 = dom.createTextNode("amountControl");
      dom.appendChild(el5, el6);
      dom.appendChild(el4, el5);
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","controls");
      ...
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","control-label");
      var el6 = dom.createTextNode("observers");
      dom.appendChild(el5, el6);
      dom.appendChild(el4, el5);
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","controls");
    ...
    render: function render(context, env, contextualElement) {
      ...
      var morph1 = dom.createMorphAt(dom.childAt(element3, [0, 1]),0,0);
      var morph2 = dom.createMorphAt(dom.childAt(element3, [1, 1]),0,0);
      var morph3 = dom.createMorphAt(dom.childAt(element3, [2, 1]),0,0);
      var morph4 = dom.createMorphAt(dom.childAt(element3, [3, 1]),0,0);
      var morph5 = dom.createMorphAt(dom.childAt(element3, [4, 1]),0,0);
...
Ember.TEMPLATES["accounts"] = Ember.HTMLBars.template((function() {
  ...
  return {
    ...
    build: function build(dom) {
      ...
      var el5 = dom.createTextNode("saldo");
      dom.appendChild(el4, el5);
      dom.appendChild(el3, el4);
      ...
      var el4 = dom.createElement("div");
      dom.setAttribute(el4,"class","pull-right");
      var el5 = dom.createTextNode("page-navigator");
      dom.appendChild(el4, el5);
      dom.appendChild(el3, el4);
      var el4 = dom.createElement("div");
    ...
    render: function render(context, env, contextualElement) {
      ...
      var element8 = dom.childAt(element7, [0, 0]);
      var element9 = dom.childAt(element7, [1]);
      var morph0 = dom.createMorphAt(dom.childAt(element5, [1]),0,0);
      var morph1 = dom.createMorphAt(dom.childAt(element9, [0]),0,0);
      var morph2 = dom.createMorphAt(dom.childAt(element9, [1]),0,0);
      var morph3 = dom.createMorphAt(dom.childAt(element9, [2]),0,0);
      var morph4 = dom.createMorphAt(dom.childAt(element9, [3]),0,0);
      var morph5 = dom.createMorphAt(dom.childAt(element6, [1]),0,0);
      content(env, morph0, context, "outlet");
      element(env, element8, context, "action", ["selectAll"], {});
      content(env, morph1, context, "viewtext1");
      content(env, morph2, context, "viewtext2");
      content(env, morph3, context, "viewtext3");
      content(env, morph4, context, "viewnumber");
      block(env, morph5, context, "each", [get(env, context, "controller")], {}, child0, null);
      return fragment;
    }
  };
}()));
Ember.TEMPLATES["application"] = Ember.HTMLBars.template((function() {
  ...
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var element6 = dom.childAt(fragment, [2, 0, 0, 0]);
      ...
      var morph5 = dom.createMorphAt(dom.childAt(fragment, [3]),0,0);
      var morph6 = dom.createMorphAt(dom.childAt(element7, [0, 0, 1]),0,0);
      var morph7 = dom.createMorphAt(dom.childAt(element7, [1, 0, 1]),0,0);
...
Ember.TEMPLATES["category"] = Ember.HTMLBars.template((function() {
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var element2 = dom.childAt(fragment, [1, 0]);
      var morph0 = dom.createMorphAt(dom.childAt(element0, [0]),1,1);
      var morph1 = dom.createMorphAt(dom.childAt(element2, [0, 0, 1]),0,0);
      content(env, morph0, context, "name");
      element(env, element1, context, "action", ["save"], {});
      element(env, element2, context, "disabled", [], {});
      inline(env, morph1, context, "input", [], {"name": "name", "value": get(env, context, "name"), "required": true, "class": "span7"});
...
Ember.TEMPLATES["transaction"] = Ember.HTMLBars.template((function() {
  return {
    ...
    build: function build(dom) {
      ...
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","control-label");
      var el6 = dom.createTextNode("Category");
      dom.appendChild(el5, el6);
      dom.appendChild(el4, el5);
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","controls");
      ...
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","control-label");
      var el6 = dom.createTextNode("Cost center");
      dom.appendChild(el5, el6);
      dom.appendChild(el4, el5);
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","controls");
      ...
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","control-label");
      var el6 = dom.createTextNode("Basis");
      dom.appendChild(el5, el6);
      dom.appendChild(el4, el5);
      var el5 = dom.createElement("div");
      dom.setAttribute(el5,"class","controls");
      ...
      var el3 = dom.createTextNode("doc info");
      dom.appendChild(el2, el3);
      dom.appendChild(el1, el2);
      dom.appendChild(el0, el1);
      return el0;
    ...
    render: function render(context, env, contextualElement) {
      ...
      var morph3 = dom.createMorphAt(dom.childAt(element3, [1, 1]),0,0);
      var morph4 = dom.createMorphAt(dom.childAt(element3, [3, 1]),0,0);
      var morph5 = dom.createMorphAt(dom.childAt(element3, [5, 1]),0,0);
      var morph6 = dom.createMorphAt(dom.childAt(element3, [8, 1]),0,0);
      var morph7 = dom.createMorphAt(dom.childAt(element3, [10, 1]),0,0);
      var morph8 = dom.createMorphAt(dom.childAt(element3, [12, 1]),0,0);
...
Ember.TEMPLATES["transactions"] = Ember.HTMLBars.template((function() {
    ...
    var child0 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph4 = dom.createMorphAt(dom.childAt(element0, [6, 0]),0,0);
  ...
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var morph1 = dom.createMorphAt(dom.childAt(element7, [2, 1]),0,0);
      content(env, morph0, context, "outlet");
      block(env, morph1, context, "each", [get(env, context, "controller")], {}, child0, null);
      return fragment;
    }
...
Ember.TEMPLATES["users"] = Ember.HTMLBars.template((function() {
  ...
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      var element0 = dom.childAt(fragment, [0]);
      var morph0 = dom.createMorphAt(dom.childAt(element0, [1]),0,0);
      var morph1 = dom.createMorphAt(dom.childAt(element0, [2, 0]),0,0);
      content(env, morph0, context, "outlet");
      block(env, morph1, context, "each", [get(env, context, "controller")], {}, child0, null);
      return fragment;
    }
