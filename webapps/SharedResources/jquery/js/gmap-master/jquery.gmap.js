...
(function($) {
  ...
  methods = {
    ...
    getRoute: function(options) {
      ...
      // look if there is an individual or otherwise a default object for this call to display objects text informations
      ...
      $directionsService.route(request, function(result, status) {
        // show the rout or otherwise show an error message in a defined container for objects text information
  ...
  $.fn.gMap.defaults = {
    ...
    routeFinder: {
      ...
      routeErrors:	{
        ...
        'ZERO_RESULTS': 'No objects could be found within the given addresses.'
      }
    },
