...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			rowFilter: ' ',
			colFilter: ' ',
			colors: ['#be1e2d','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744','#1E90FF','#9932CC','#FF6347','#228B22','#BDB76B','#7B68EE','#B3EE3A','#EE3A8C','#008B8B','#90EE90','#5D478B','#FF6EB4','#EECFA1','#D3D3D3'],
