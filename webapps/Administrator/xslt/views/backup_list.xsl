				...
				<div class="wrapper">
					...
					<div class="layout-content">
						<div class="layout-content-container">
							<h4 class="view-header-title">Backup</h4>
							<div class="actionbar">
								<span class="action">
									<a>
									...
									<tr onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
										...
										<td style="border:1px solid #ccc; padding-left:5px">
											<a class="doclink" title="{name}">
												<xsl:attribute name="href">Provider?type=edit&amp;element=backup&amp;id=<xsl:value-of select="name"/>&amp;app=<xsl:value-of select="app"/></xsl:attribute>
