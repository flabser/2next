...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>Administrator - Forms list</title>
					...
					<div class="layout-content">
						<div class="layout-content-container">
							<h4 class="view-header-title">
								<xsl:value-of select="concat(query/@app,'Forms')"/>
							</h4>
							<div class="actionbar">
								<span class="action">
									...
									<a style="margin-left:10px">
										<xsl:attribute name="href">javascript:delRule("form_rule");</xsl:attribute>
									...
									<tr onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
										...
										<td style="border:1px solid #ccc; padding-left:5px;">
											<a class="doclink" title="{filename}">
												<xsl:attribute name="href">Provider?type=get_query&amp;id=<xsl:value-of select="@docid"/>&amp;app=<xsl:value-of select="app"/></xsl:attribute>
